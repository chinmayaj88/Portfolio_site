      ...
      <div className={styles.container}>
        ...
        >
          ...
          >
            <div className={styles.profileHeader}>
              ...
              >
                ...
                <div className={styles.socialLinks}>
                  {contactData.socialLinks.filter(link => ['github', 'linkedin', 'instagram'].includes(link.id)).map((link, index) => (
                    <motion.a
                      key={link.id}
                      href={link.href}
                      target="_blank"
                      ...
                      transition={{ duration: 0.3, delay: 0.7 + index * 0.1, type: "spring", stiffness: 200 }}
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      whileTap={{ scale: 0.9 }}
                    >
                      {link.icon === "gh" && (
            ...
            >
              <CallToAction text={"Get in touch"} href={`mailto:${contactData.email}`} />
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
